...
namespace AssessmentLibrary
{
    public class HTTPBaseClass
    {
        ...
        /// &lt;returns>&lt;/returns>
        public virtual HttpWebRequest CreateWebRequest(bool NwCred)
        {
        ...
        public virtual HttpWebResponse GetFinalResponse(string Cookie, bool NwCred)
        {
            ...
            HttpWebRequest webrequest = CreateWebRequest(NwCred);
